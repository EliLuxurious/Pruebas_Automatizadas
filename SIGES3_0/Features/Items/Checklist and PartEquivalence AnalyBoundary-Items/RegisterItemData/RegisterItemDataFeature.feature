...
And el usuario ingresa el valor a asignar "PRUEBA5"
And el usuario arrastra el valor "PRUEBA5"
Then se guarda la asignacion



Scenario: Registrar presentación inválida con la partición negativa con respecto al campo Código
When el usuario selecciona la opcion Presentación
And el usuario ingresa el codigo de presentación "PR"
And el usuario ingresa el nombre de presentación "TUBO"
And el usuario ingresa la descripcion de presentación "Presentación en tubo"
Then no se guarda el registro