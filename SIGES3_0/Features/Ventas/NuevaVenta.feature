...
@NuevaVenta
@VentaNormal
Scenario Outline: Flujo de ventas con diferentes clientes
    ...
    Examples:
      ...
      | CP006 | gaseosa | Inca Kola Gaseosa Botella 1.5L  | 150      | 00000000    | NOTA DE VENTA(INTERNA)      | NV02  | Inmediata | Completo   | SI         | SI       | Se registro correctamente |
      | CP007 | gaseosa | Inca Kola Gaseosa Botella 1.5L  | 150      | 75893616    | NOTA DE VENTA(INTERNA)      | NV02  | Inmediata | Incompleto | SI         | SI       | insuficiente              |
