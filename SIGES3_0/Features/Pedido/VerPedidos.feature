...
#	And el usuario valida direccion de origen '<direccion_origen>'
#	And el usuario valida direccion de destino '<direccion_destino>'
#	And el usuario configura el pago 'efectivo' '<monto_cubre_total>'
#	And el usuario confirma el pedido preparado
#	Then el sistema valida '<resultado_esperado>'
#
#Examples:
#	| caso | total_mayor_700 | tipo_comprobante            | serie   | cliente     | tipo_entrega | guia_remision | monto_cubre_total | resultado_esperado                                                               |
...
Examples:
	| caso | total_mayor_700 | tipo_comprobante            | serie   | cliente     | tipo_entrega | guia_remision | fecha_de_inicio_traslado | peso_bruto | cantidad_bultos | tipo_transporte | transportista_ruc | dni_conductor | numero_licencia | numero_placa | direccion_origen           | direccion_destino | monto_cubre_total | resultado_esperado                                                      |
	|    1 | false           | factura electronica         | F002    | 20542245671 | inmediata    | true          | Hoy                      |        100 |              10 | Publico         |       20602945589 | NA            | NA              | NA           | Huanuco-Leoncio-Rupa Rupa  | Lima-Lima-Lima    | true              | Pedido confirmado correctamente                                         |
	|    2 | false           | factura electronica         | F002    |    75971755 | inmediata    | false         | NA                       | NA         | NA              | NA              | NA                | NA            | NA              | NA           | NA                         | NA                | true              | Para emitir Factura Electrónica, el cliente debe tener RUC (11 dígitos) |
	|    3 | false           | factura electronica         | ninguno | 20542245671 | diferida     | false         | NA                       | NA         | NA              | NA              | NA                | NA            | NA              | NA           | NA                         | NA                | true              | Ingrese el numero de serie                                              |
	|    4 | false           | factura electronica         | F002    | 20542245671 | inmediata    | false         | NA                       | NA         | NA              | NA              | NA                | NA            | NA              | NA           | NA                         | NA                | false             | Monto insuficiente                                                      |
	|    5 | true            | boleta de venta electronica | B002    |    75971635 | diferida     | false         | NA                       | NA         | NA              | NA              | NA                | NA            | NA              | NA           | NA                         | NA                | true              | Pedido confirmado correctamente                                         |
	|    6 | false           | boleta de venta electronica | B002    |    00000000 | inmediata    | false         | NA                       | NA         | NA              | NA              | NA                | NA            | NA              | NA           | NA                         | NA                | true              | Pedido confirmado correctamente                                         |
	|    7 | true            | boleta de venta electronica | B002    |    00000000 | inmediata    | false         | NA                       | NA         | NA              | NA              | NA                | NA            | NA              | NA           | NA                         | NA                | true              | Es necesario identificar al cliente, el total es mayor a S/.700         |
	|    8 | false           | nota de venta               | NV02    |    75971755 | diferida     | false         | NA                       | NA         | NA              | NA              | NA                | NA            | NA              | NA           | NA                         | NA                | true              | Pedido confirmado correctamente                                         |
	|    9 | false           | nota de venta               | NV02    | 20602945589 | inmediata    | false         | NA                       | NA         | NA              | NA              | NA                | NA            | NA              | NA           | NA                         | NA                | true              | Pedido confirmado correctamente                                         |
	|   10 | false           | nota de venta               | NV02    | 20602945589 | inmediata    | false         | NA                       | NA         | NA              | NA              |       20602945589 | NA            | NA              | NA           | NA                         | NA                | false             | Monto insuficiente                                                      |
	|   11 | false           | boleta de venta electronica | B002    |    00000000 | inmediata    | true          | Hoy                      |        100 |              10 | Privado         | NA                |      71310154 | M-71310154      | 2770XS       | Arequipa-Arequipa-Arequipa | Lima-Lima-Lima    | true              | Boton de guia de remision inhabilitado "Para guia de remision Necesita identificar al cliente con RUC o DNI"     |


@EditarPedido
Scenario Outline: Editar pedido - Casos variados

	Given existe un pedido base registrado para editar
	When el usuario selecciona la opción 'Editar pedido'
	And el usuario realiza el cambio '<tipo_cambio>'
	And el usuario hace clic en 'Editar pedido'
	#Then el sistema valida '<resultado_esperado>'
	Then el sistema valida el resultado del pedido '<resultado_esperado>'

Examples:
	| caso | tipo_cambio     | resultado_esperado                |
	|    1 | cambio_valido   | Se registró correctamente         |
	|    2 | sin_cambios     | Debe realizar alguna modificación |
	|    3 | datos_invalidos | Error de validación en los datos  |
